    ...
    private fun InventoryBuilder.generateLocationEdit(
        ...
        .apply {
            ...
            if (yawAndPitch) {
                setItem(
                    18,
                    SkullItemBuilder().setOwner("MHF_ArrowLeft").setName("${TEXT}Yaw: $IMPORTANT${location.yaw}")
                        .build()
                )
                setItem(
                    26,
                    SkullItemBuilder().setOwner("MHF_ArrowRight").setName("${TEXT}Pitch: $IMPORTANT${location.pitch}")
                        .build()
                )
            }
        }
